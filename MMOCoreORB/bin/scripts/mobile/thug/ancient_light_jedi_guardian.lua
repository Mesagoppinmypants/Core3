ancient_light_jedi_guardian = Creature:new {
	customName = "an Ancient Light Jedi Guardian",
...
CreatureTemplates:addCreatureTemplate(ancient_light_jedi_guardian, "ancient_light_jedi_guardian")
