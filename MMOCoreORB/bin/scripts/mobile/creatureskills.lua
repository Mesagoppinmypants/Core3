...
forcepowermaster = { {"forcelightningsingle2",""},{"forcelightningcone2",""},{"mindblast2",""},{"forceknockdown3",""},{"forceweaken2",""},{"forcethrow2",""},{"forcechoke",""} }
lightjedimaster = {{"forcearmor2", ""},{"forcefeedback2", ""},{"healAllSelf2npc", ""} }
